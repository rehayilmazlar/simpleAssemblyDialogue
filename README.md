...
<p align="left">I used <strong>RadASM</strong> as an <strong>IDE</strong> and <strong>MASM</strong> to compile assembly code. Here we only need three files to create, the rest of the files are created by RadASM automatically. Best thing about RadASM is you can create your dialogue visually and add buttons, text box etc. to it.
<br>
 <br>Those 3 files we need to create are:
  <ul>
   ...
   <li>TestDialogue.Inc <em>--And here is our include file that includes everything we need such as libraries, button IDs, variables etc.</em></li>
  </ul>
